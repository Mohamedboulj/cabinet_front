...
import { invoiceService } from '@/features/invoices/api/invoices.api';
...
import InvoiceDetailSkeleton from '@/features/invoices/components/skeletons/InvoiceDetailSkeleton';
